...
def train_kfold(train_data_file,
    ...
    for train, test in kfold.split(X, Y):
        ...
        filename = './data/promoter_best_model_gene_bert_{}_fold_{}_gram_{}_11_Knowledge_distmask_tsspm100.h5'.format(str(k_fold), str(ngram), task_name)
...
if __name__ == '__main__':
    ...
    data_path = './data/5_gram_11_knowledge_distmask_tsspm100'
